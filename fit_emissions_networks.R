...
percent.of.powerplants = 20 #percent of power plants to use
k1 = 5
wind.speed = 13 #kph
...
cutoff.perc = 0.70
plotEmissionsNetwork(edges, emissions, 
                     PM, PP_locations, M_locations,
                     main = "",plot.diagnostics = TRUE,
                     plot.percent.of.powerplants = 100)
plotHighLowMap(edges, PP_locations, M_locations, cutoff.perc = cutoff.perc,
               main = "")
